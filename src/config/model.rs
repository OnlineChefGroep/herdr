...
impl SpinnerStyle {
    pub const ALL: &[Self] = &[
        Self::Dots, Self::DotsFull, Self::DotsCorner, Self::Arc, Self::Circle,
        Self::CircleQuarters, Self::CircleHalves, Self::SquareCorners, Self::Triangle,
        Self::Star, Self::Star2, Self::Arrow, Self::Arrow3, Self::Bounce, Self::BoxBounce,
        Self::Pipe, Self::Noise, Self::Aesthetic, Self::GrowVertical, Self::GrowHorizontal,
        Self::Point, Self::BetaWave, Self::Layer, Self::Liquid, Self::Crystal, Self::Galaxy,
        Self::Vortex, Self::Toggle, Self::Flip, Self::Sandwich, Self::BouncingBar,
        Self::BouncingBall, Self::Pong, Self::Shark, Self::Fish, Self::Binary, Self::DotsCircle,
        Self::Sand, Self::Dots8Bit,
        Self::Moon, Self::Clock, Self::Earth, Self::Weather, Self::Hearts, Self::Balloon,
        Self::Grenade, Self::FingerDance, Self::FistBump, Self::Smiley, Self::Monkey,
        Self::Speaker, Self::Runner, Self::SoccerHeader, Self::Mindblown, Self::OrangePulse,
        Self::BluePulse, Self::OrangeBluePulse, Self::TimeTravel, Self::Christmas,
        Self::Flame, Self::Pizza, Self::Dizzy, Self::Ninja, Self::Magic, Self::Robot,
        Self::Boom, Self::Unicorn, Self::Bee, Self::Dragon, Self::Ghost, Self::Pumpkin,
        Self::Wizard, Self::Crown, Self::Diamond, Self::Fire, Self::Rocket, Self::StarSpin,
        Self::Confetti, Self::Cthulhu, Self::DwarfFortress,
    ];
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            Self::Arc => "arc",
            Self::Circle => "circle",
            Self::CircleQuarters => "circle quarters",
            Self::CircleHalves => "circle halves",
            Self::SquareCorners => "square corners",
            Self::Triangle => "triangle",
            Self::Star => "star",
            Self::Star2 => "star 2",
            Self::Arrow => "arrow",
            Self::Arrow3 => "arrow slide",
            Self::Bounce => "bounce",
            Self::BoxBounce => "box bounce",
            Self::Pipe => "pipe",
            Self::Noise => "noise",
            ...
            Self::BouncingBar => "bouncing bar",
            Self::BouncingBall => "bouncing ball",
            Self::Pong => "pong",
            Self::Shark => "shark",
            Self::Fish => "fish",
            Self::Binary => "binary",
            Self::DotsCircle => "dots circle",
            Self::Sand => "sand",
            Self::Dots8Bit => "8-bit",
            Self::Moon => "moon",
            Self::Clock => "clock",
            ...
            Self::FingerDance => "finger dance",
            Self::FistBump => "fist bump",
            Self::Smiley => "smiley",
            Self::Monkey => "monkey",
            Self::Speaker => "speaker",
            Self::Runner => "runner",
            Self::SoccerHeader => "soccer header",
            Self::Mindblown => "mindblown",
            Self::OrangePulse => "orange pulse",
            Self::BluePulse => "blue pulse",
            Self::OrangeBluePulse => "orange blue pulse",
    ...
    pub fn frames(self) -> &'static [&'static str] {
        match self {
            ...
            Self::GrowHorizontal => &["▏", "▎", "▍", "▌", "▋", "▊", "▉", "▊", "▋", "▌", "▍", "▎"],
            Self::Point => &["∙∙∙", "●∙∙", "∙●∙", "∙∙●", "∙∙∙"],
            Self::BetaWave => &["ρββββββ", "βρβββββ", "ββρββββ", "βββρβββ", "ββββρββ", "βββββρβ", "ββββββρ"],
            Self::Layer => &["-", "=", "≡"],
            Self::Liquid => &["▘", "▝", "▗", "▖", "▘", "▝", "▗", "▖"],
            Self::Crystal => &["◇", "◈", "◆", "◈", "◇"],
            Self::Galaxy => &["⋅", "✦", "✧", "★", "✧", "✦", "⋅", "⋅"],
            ...
            Self::Speaker => &["🔈 ", "🔉 ", "🔊 ", "🔉 "],
            Self::Runner => &["🚶 ", "🏃 "],
            Self::SoccerHeader => &[" 🧑⚽️       🧑 ", "🧑  ⚽️      🧑 ", "🧑   ⚽️     🧑 ", "🧑    ⚽️    🧑 ", "🧑     ⚽️   🧑 ", "🧑      ⚽️  🧑 ", "🧑       ⚽️🧑  ", "🧑      ⚽️  🧑 ", "🧑     ⚽️   🧑 ", "🧑    ⚽️    🧑 ", "🧑   ⚽️     🧑 ", "🧑  ⚽️      🧑 "],
            Self::Mindblown => &["😐 ", "😐 ", "😮 ", "😮 ", "😦 ", "😦 ", "😧 ", "😧 ", "🤯 ", "💥 ", "✨ ", "　 "],
            Self::OrangePulse => &["🔸 ", "🔶 ", "🟠 ", "🟠 ", "🔶 "],
            Self::BluePulse => &["🔹 ", "🔷 ", "🔵 ", "🔵 ", "🔷 "],
    ...
    pub fn speed_divisor(self) -> u32 {
        let interval_ms = match self {
            Self::Dots | Self::DotsFull | Self::DotsCorner | Self::Bounce
            | Self::BouncingBar | Self::BouncingBall | Self::Pong | Self::Shark
            ...
            | Self::OrangePulse | Self::BluePulse | Self::OrangeBluePulse
            | Self::TimeTravel | Self::StarSpin | Self::Cthulhu => 120,
            Self::CircleHalves | Self::Triangle | Self::Aesthetic
            | Self::Flip | Self::Sandwich => 50,
            Self::SquareCorners => 180,
            Self::GrowVertical | Self::GrowHorizontal => 120,
            Self::Point => 125,
            Self::Layer => 150,
            Self::Liquid => 100,
            Self::Crystal | Self::Diamond => 150,
            Self::Runner => 140,
            Self::SoccerHeader | Self::FistBump => 80,
            Self::FingerDance | Self::Mindblown | Self::Speaker | Self::Monkey => 160,
            Self::Smiley => 200,
            Self::Christmas => 400,
...
pub struct KeysConfig {
    /// Prefix key to enter prefix mode (e.g. "ctrl+a", "ctrl+b", "f12", "esc").
    pub prefix: String,
