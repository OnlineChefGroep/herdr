...
herdr channel show            # print stable, preview, or dev
herdr channel set preview     # opt into preview builds
herdr channel set dev         # opt into dev builds
